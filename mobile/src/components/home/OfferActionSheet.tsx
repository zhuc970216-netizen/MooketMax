...
export function OfferActionSheet({
  visible,
  item,
  intentAdded,
  onClose,
...
function buildMeta(item: OfferFeedItem) {
  return (
    [item.feedingType, item.weight, item.goodsLocation || item.region, item.tags]
...
const styles = StyleSheet.create({
  ...
  merchantLine: {marginTop: 3, flexDirection: 'row', alignItems: 'center', gap: 8},
  merchant: {flexShrink: 1, color: colors.textMuted, fontSize: 13, lineHeight: 17},
  viewMerchantButton: {height: 20, justifyContent: 'center'},
  viewMerchantText: {color: colors.primary, fontSize: 12, lineHeight: 16, fontWeight: '400'},
  ...
  actionIcon: {width: 32, height: 32, borderRadius: 16, backgroundColor: colors.primaryLight, alignItems: 'center', justifyContent: 'center'},
  actionIconDisabled: {backgroundColor: '#F1F3F2', opacity: 0.58},
